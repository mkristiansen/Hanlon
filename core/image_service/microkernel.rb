  ...
  module ImageService
    ...
    class MicroKernel < ProjectHanlon::ImageService::Base
      ...
      def cloud_config
        ...
        config_string << "        echo \"docker daemon not found; sleeping for $sleep_time seconds...\" >> /tmp/start-mk.out\n"
        config_string << "        sleep $sleep_time\n"
        config_string << "      done\n"
        config_string << "      # load Microkernel image and start the Microkernel\n"
        config_string << "        echo \"docker daemon found; loading (and starting) Microkernel...\" >> /tmp/start-mk.out\n"
